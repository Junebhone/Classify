...
class ListingController extends Controller
{
    ...
    public function store(StoreListingRequest $request)
    {
        ...
        return redirect()->route('admin.listings.index')->with('noti', ["icon" => "success", "title" => "Listing Successfully Created"]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.listings.index')->with('noti', ["icon" => "success", "title" => "Listing Successfully Edited"]);
    }
    ...
    public function destroy($id)
    {
        ...
        $listing->delete();
        return redirect()->route('admin.listings.index')->with('noti', ["icon" => "success", "title" => "Listing Successfully Deleted"]);
    }
}