<x-app-layout>
    ...
    <div class="container mx-auto ">
        @if(session('message'))
        <div class="bg-indigo-600 text-gray-200 m-2 p-2 text-lg text-center">{{ session('message') }}</div>
        @endif
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <form method="POST"
                                            ...
                                            <a class="text-red-600 hover:text-red-900"
                                                href="{{ route('childcategories.destroy',$category->id) }}" onclick="event.preventDefault();
