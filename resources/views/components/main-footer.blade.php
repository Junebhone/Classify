<footer class="py-4 px-8 mt-20 bg-white ">
            ...
            <a href="https://flowbite.com" class="flex gap-4 items-center">
                <svg class="w-8 h-8 " viewBox="0 0 364 373" fill="none" xmlns="http://www.w3.org/2000/svg%22%3E">
                    <path
                        ...
                        fill="black" />
                    <rect x="149" y="157" width="26" height="26" fill="black" />
                    <rect x="189" y="157" width="26" height="26" fill="black" />
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul class="text-gray-600 ">
                    ...
                    <li>
                        <a href="https://tailwindcss.com/" class="text-gray-400 hover:underline">Tailwind CSS</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-600 ">
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite"
                            class="text-gray-400 hover:underline ">Github</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" class="text-gray-400 hover:underline">Discord</a>
                    </li>
                </ul>
            </div>
            <div>
