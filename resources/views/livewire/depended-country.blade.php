<div class="grid grid-cols-6 gap-6 mt-5">
    <div class="col-span-6 sm:col-span-3 md:col-span-2">
        ...
        <select wire:model="selectedCountry" name="country_id" class="mt-2 border-gray-300 focus:border-[#FF385C]
    ...
    <div class="col-span-6 sm:col-span-3 md:col-span-2">
        ...
        <select wire:model="selectedState" name="state_id" class="mt-2 border-gray-300 focus:border-[#FF385C]
            focus:ring focus:ring-red-300 focus:ring-opacity-50 rounded-md shadow-sm flex-1 block w-full sm:text-sm">
    ...
    <div class="col-span-6 sm:col-span-3 md:col-span-2">
        ...
        <select name="city_id" class="mt-2 border-gray-300 focus:border-[#FF385C]
            focus:ring focus:ring-red-300 focus:ring-opacity-50 rounded-md shadow-sm flex-1 block w-full sm:text-sm">
